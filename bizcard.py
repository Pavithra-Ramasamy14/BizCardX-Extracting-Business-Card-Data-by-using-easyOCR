...
if select == "Home":
  ...
  if img is not None:
    ...
    if button_1:
      ...
      insert_query = '''INSERT INTO bizcard_details(name, designation,contact, email, website,street,city,state,
    ...
    if method == "Preview":
      ...
      table_df = pd.DataFrame(table, columns=("NAME", "DESIGNATION","CONTACT", "EMAIL", "WEBSITE","STREET",
                                              "CITY","STATE","PINCODE","COMPANY", "IMAGE"))
